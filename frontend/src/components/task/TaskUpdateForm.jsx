...
const TaskUpdateForm = ({ _data, openTaskUpdateForm, onNotify, onReset, onCloseTaskUpdateForm }) => {
    // state
    ...
    const fetchApiCreateTask = async () => {
        if (!isValid()) return;
        const data = await taskService.update(_data.taskId, task, errorNotify);
